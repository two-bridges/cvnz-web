...
function Calendar() {
  ...
  const [view, setView] = useState<any>(mobileDevice ? 'listWeek' : 'dayGridMonth');
  const [date, setDate] = useState<any>(moment('2019-07-30 08:00:00').toDate());
  const [events, setEvents] = useState<any>([]);
  const [eventModal, setEventModal] = useState<any>({
    open: false,
    event: null
  });
